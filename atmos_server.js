...
function main() {
	...
	patternsPOST[atmos.constants.pathInfo.pMessagesDelete] = function(req) { req.response.end(); };
	...
	patternsPOST[atmos.constants.pathInfo.pAnnounceDelete] = function(req) { req.response.end(); };
	...
	patternsPOST[atmos.constants.pathInfo.pPrivateDelete] = function(req) { req.response.end(); };
	...
	patternsPOST[atmos.constants.pathInfo.pMonologDelete] = function(req) { req.response.end(); };
